...
# Custom shell functions for zsh
# These provide enhanced utilities for daily development work
...
# Search for text within files recursively from current directory
function search() {
	grep -rnw "./" -e "$1"
}
...
# Open a file or directory in your editor and file browser
# Assumes you have 'code' (VS Code) or another editor configured
function edit() {
	[[ -d $1 ]] && cd $1 && code $1 && open $1 && return 0
	[[ -e $1 ]] && open $1 && return 0
	echo "invalid path"
}
